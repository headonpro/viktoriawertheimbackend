  ...
  return (
    <PageLayout>
      <div className="space-y-8">
            ...
            <div className="container max-w-6xl md:max-w-7xl">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  >
                    ...
                    <div className="bg-white/20 px-4 md:px-6 py-3 border-b border-white/20">
                      <div className="grid grid-cols-12 gap-2 text-xs md:text-sm font-medium text-gray-600 uppercase tracking-wide">
                    ...
                    <div className="divide-y divide-white/10 py-2 md:py-3">
                      ...
                      <div className="relative overflow-hidden rounded-xl md:rounded-2xl transition-all duration-300 hover:shadow-xl md:hover:shadow-2xl cursor-pointer group h-full flex flex-col shadow-lg">
                      ...
                      {topScorers.slice(1).map((player, index) => (
                        <div key={player.id} className="px-4 md:px-6 py-2.5 md:py-3 transition-all duration-300 hover:bg-white/30">
              ...
              {newsArticles.slice(0, 3).map((article, index) => {
                ...
                return (
                  <AnimatedDiv 
                    key={article.id}
                    className="bg-white/40 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/20 p-3 md:p-6 cursor-pointer hover:bg-white/50 transition-all duration-300 md:shadow-lg md:hover:shadow-xl"
                    direction="left"
                    delay={0.4 + index * 0.1}
                  >
        ...
        {/* Sponsors Section */}
        <AnimatedSection className="px-4 md:px-8 pb-8" delay={0.5}>
          <div className="container max-w-6xl md:max-w-7xl">
            <h2 className="text-sm md:text-lg font-semibold text-gray-600 uppercase tracking-wide mb-4 md:mb-6 text-center">
              Unsere Sponsoren
            </h2>
